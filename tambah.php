...
<head>
    ...
    <title>Tambah | Data Pegawai | LAPORAN KERJA</title>
</head>
<body>
    <!-- Navbar -->
...
<div class="container">
    ...
    <div class="row my-3">
        <div class="col-md">
            <h2><i class="bi bi-person-plus-fill"></i>&nbsp;Tambah Data Pegawai</h2>
        </div>
        <hr>
    </div>
    <div class="row mb-3">
        <div class="col-md">
            ...
            <div class="mb-3">
                ...
                <input type="number" class="form-control w-50" id="exampleFormControlInput1" placeholder="ID" name="id" autocomplete="off" required>
            </div>
            <div class="mb-3">
                <label for="nip_nik" class="form-label">NIP/NIK</label>
                <input type="number" class="form-control w-50" id="exampleFormControlInput1" placeholder="NIP/NIK" name="nip_nik" autocomplete="off" required>
            </div>
            <div class="mb-3">
                <label for="nama" class="form-label">Nama Lengkap</label>
                <input type="text" class="form-control w-50" id="exampleFormControlInput1" placeholder="Nama Lengkap" name="nama" autocomplete="off" required>
            </div>
            <div class="mb-3">
                <label>Jabatan</label>
            ...
            <?php
                if(isset($_GET['ubah'])){
            ?>
                <button type="submit" name="tambah" class="btn btn-primary">Simpan
